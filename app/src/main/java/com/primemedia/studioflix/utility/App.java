...
import com.primemedia.studioflix.Downloads;
import com.primemedia.studioflix.R;
import com.primemedia.studioflix.Splash;
...
//                .setHttpDownloader(new OkHttpDownloader(Downloader.FileDownloaderType.PARALLEL))
    ...
    public void checkDevice(int userID) {
        ...
        @SuppressLint("HardwareIds") StringRequest sr = new StringRequest(Request.Method.GET, SC.reveal(Constants.url) +"check_device/"+userID, response -> {
